...
/******/ (() => {
    ...
    /***/ 5332: /***/ (module, exports, __nccwpck_require__) => {
      ...
      try {
        ...
        if (supportsColor && (supportsColor.stderr || supportsColor).level >= 2) {
          exports.colors = [
            20, 21, 26, 27, 32, 33, 38, 39, 40, 41, 42, 43, 44, 45, 56, 57, 62, 63, 68, 69, 74, 75, 76, 77, 78, 79, 80, 81, 92, 93, 98, 99,
            112, 113, 128, 129, 134, 135, 148, 149, 160, 161, 162, 163, 164, 165, 166, 167, 168, 169, 170, 171, 172, 173, 178, 179, 184,
  ...
  (() => {
    ...
    try {
      ...
      const extention = core.getInput('extention');

      const options = {
        method: 'GET',
        url: `https://domaine-nc.p.rapidapi.com/${name}/${extention}`,
        headers: {
      ...
      axios
        ...
        .then(function (response) {
          if (response.data.expired) {
            core.wan(`⚠️ ${name}.${extention} is expired since ${response.data.dateExpiration} ⚠️`);
          } else {
            core.info(`✅ ${name}.${extention} expires within ${response.data.nbDaysBeforeExpires} day(s)`);
          }
